...
// 08-FEB-2008 added by y.t.
extern "C"
{
  void findfile(char *, char *, char *, char *, int);
}
...
binfile::binfile(char *name,char mode)
{
  ...
  // 08-FEB-2008 modified by y.t.
  //  char file_name[1024];
  //  findfile(file_name, name, "SKPATH", ConstDirC, 1024);
  //  fp=fopen(file_name,allmode);
